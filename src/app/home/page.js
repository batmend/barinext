  ...
  return (
    <>
      ...
      <div className="page-content bg-white">
        ...
        >
          <div className="container">
            <div className="banner-inner">
              <div className="img1">
                <Image src={ThemeImage.SliderBnr3} alt="" />
              </div>
              <div className="img2">
                <Image src={ThemeImage.SliderBnr4} alt="" />
              </div>
                ...
                <div className="col-md-7">
                  <div className="banner-content">
                    ...
                    >
                      ...
                      nibh. Pellentesque vitae ante at elit fringilla ac at
                      purus.
                    </p>
                    <a
                    ...
                    >
                      Learn More<i className="fa fa-angle-right m-l10"></i>
                    </a>
                  </div>
                </div>
        ...
        <section
          style={{
            backgroundImage: `url('${ThemeImage.BackBg1.src}')`,
            backgroundSize: "100%",
          }}
        >
        ...
        <section
          ...
          style={{
            backgroundImage: `url('${ThemeImage.BackBg19.src}')`,
            backgroundSize: "100%",
          }}
        >
          <div className="container">
        ...
        <section
          ...
          style={{
            backgroundImage: `url('${ThemeImage.BackBg13.src}')`,
        ...
        <section
          className="content-inner"
          style={{
            backgroundImage: `url('${ThemeImage.BackBg20.src}')`,
            backgroundSize: "100%",
            ...
            <div className="row testimonials-wraper-1 align-items-center">
              ...
              >
                <div className="section-head style-1">
                  ...
                  <p>
                    Nunc vel ligula ut erat scelerisque vehicula sit amet
                    porttitor magna. Donec malesuada quis diam quis
                    pellentesque.
                  </p>
                </div>
              </div>
